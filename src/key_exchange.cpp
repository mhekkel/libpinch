...
struct key_exchange_impl
{
	...
	virtual bool process(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
	{
		bool handled = true;
	...
	void process_kex_dh_reply(ipacket &in, opacket &out, asio_system_ns::error_code &ec);
...
void key_exchange_impl::process_kex_dh_reply(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
{
...
template <class HashAlgorithm>
bool key_exchange_dh_group<HashAlgorithm>::process(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
{
	bool handled = true;
...
template <typename HashAlgorithm>
bool key_exchange_dh_gex<HashAlgorithm>::process(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
{
	bool handled = true;
...
bool key_exchange::process(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
{
	bool handled = true;
...
opacket key_exchange::process(ipacket &in)
{
...
void key_exchange::process_kexinit(ipacket &in, opacket &out, asio_system_ns::error_code &ec)
{
	m_host_payload = in;
